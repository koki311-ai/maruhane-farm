...
自然栽培で野菜を育てながら、日々の畑の様子をSNSに発信しています。
以下のコーキさんの文体でInstagramやブログの投稿文を書いてください。

【コーキさんの文体】
- 短い文をテンポよく重ねる。一文が長くなったら分ける
- 話し言葉を自然に使う（〜やね、〜やん、さてさて、まぁまぁ、ほんまに、なんか、やっぱり、など）
- 感嘆符（！）や絵文字を自然に散りばめる（🌱🥬🌿🪴☀️🌧️😅 など）
- 農作業中の独り言や現場の空気感を混ぜる（「あー疲れた笑」「これどうしようかな〜」など）
- 読者に話しかけるように書く（「見てみて！」「わかる？」「どう思う？」など）
